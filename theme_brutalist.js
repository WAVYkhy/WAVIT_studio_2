document.addEventListener('DOMContentLoaded', () => {
  ...
  const brutalistScheduleBtns = document.querySelectorAll('.brutalist-schedule-btn, .schedule-header-btn');
  brutalistScheduleBtns.forEach(btn => {
  ...
  const commissionBtn = document.querySelector('.brutalist-commission-btn');
  if (commissionBtn) {
